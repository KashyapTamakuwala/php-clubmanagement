...
if(isset($_POST["booknow"]))
{
	...
	try{
		...
		$sql="insert into rest (name, emailid, phonenumber,start_time, end_time,res_date, mid) values ('".$name."','".$email."','".$phone."','".$start_time."','".$end_time."','".$date."','".$mid."')";
...
<html lang="en">
	<head>
		...
		<title>Risotto Restaurant</title>
	...
	<body>
		...
		<header id="header">
			...
			<div id="bottom-nav">
				...
				<nav id="nav">
					...
					<!-- button nav -->
					<ul class="cta-nav">
						<li><a href="/clubmanagement/logout.php" class="main-button">Logout</a></li>
						<li><a href="/clubmanagement/Regna/" class="main-button">Go to Regna</a></li>
					</ul>
					<!-- button nav -->
			...
			<div class="home-wrapper">
				...
				<div class="col-md-10 col-md-offset-1 text-center">
					<div class="home-content">
						...
						<br>
						<br>
						<button class="main-button"><a href="#menu">Discover Menu</a></button>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-offset-1 col-sm-10 col-sm-offset-1">
						<form class="reserve-form row" method=post>
							<div class="section-header text-center">
							...
							<div class="form-group">
									...
									<input class="input" type="number" name="mid" placeholder="Membership ID" id="mid">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input class="input" type="tel" name="phone" placeholder="Phone" id="phone">
								</div>
								<div class="form-group">
									<label for="date">Date:</label>
									<input class="input" type="date" name="date" placeholder="YYYY/DD/MM" id="date">
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
										...
										<input class="input" type="time" name="start_time" placeholder="HH:MM" id="time">
									</div>
								<div class="form-group">
								  <label for="time">End Time:</label>
								  <input class="input" type="time" name="end_time" placeholder="HH:MM" id="time">
								</div>
							</div>

							<div class="col-md-12 text-center">
								<input type="submit" class="main-button" value="Book Now" name="booknow" />
							</div>
		...
		<div id="contact" class="section">
			...
			<!-- map -->
			<div id="map">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3681.300231767477!2d72.87822071496154!3d22.679864785127727!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e5adf306c3b87%3A0xda70cb93d6f36113!2sFaculty+Of+Technology+DDIT!5e0!3m2!1sen!2sin!4v1552409700680" width="100%" height="100%" frameborder="0" style="border:0" allowfullscreen></iframe>
			</div>
			<!-- /map -->
